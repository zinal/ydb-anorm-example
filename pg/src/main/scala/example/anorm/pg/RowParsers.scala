...
/** Demonstrates building and composing RowParsers: manual construction with get[T],
  * built-in helpers (str, int, bool), the ~ combinator, map, flatten, and parsers
  * for joined / aggregate queries.
  */
object RowParsers {
