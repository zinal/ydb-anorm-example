...
/** Demonstrates parameter binding techniques: named parameters via on(),
  * NamedParameter instances, multi-value IN clauses with SeqParameter,
  * optional parameter handling, and SQL string interpolation.
  */
