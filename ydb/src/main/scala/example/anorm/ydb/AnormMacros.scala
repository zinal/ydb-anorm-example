...
/** Demonstrates Anorm macro-generated parsers against YDB:
  * Macro.namedParser for direct column-name-to-field mapping,
  * ColumnNaming.SnakeCase for automatic camelCase→snake_case translation,
  * and Macro.indexedParser for positional matching.
  */
object AnormMacros {
